...
function setEventRewards(eim) {
    ...
    eim.setEventRewards(evLevel, itemSet, itemQty, 75000);
    ...
    eim.setEventRewards(evLevel, itemSet, itemQty, 10000);
    ...
    eim.setEventRewards(evLevel, itemSet, itemQty, 5000);
    ...
    eim.setEventRewards(evLevel, itemSet, itemQty, 2500);
}
