            ...
            if (selection == 0) {
                if (cm.getParty() == null) {
                    ...
                    if (eli.size() > 0) {
                        ...
                        cm.sendOk("Your party needs to consist of 2 to 6 members in order to tackle this maze.");
                    }
